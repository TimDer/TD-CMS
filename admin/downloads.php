                          ...
                          if ($downloadsSqlQuery->num_rows > 0) {
                            while ($rows = mysqli_fetch_assoc($downloadsSqlQuery)) {
                              ...
                              <tr>
                                ...
                                <td>/download_helper.php?download_id=<?php echo $rows['sha1_download']; ?></td>
                                <td><a href="<?php echo BASE_URL ?>/download_helper.php?download_id=<?php echo $rows['sha1_download']; ?>" class="btn btn-primary">Download: <?php echo $rows['the_file_name']; ?></a></td>
