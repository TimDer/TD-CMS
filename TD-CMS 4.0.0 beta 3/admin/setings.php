                                ...
                                <div class="text-field text-left space-in-content"> 
                                    ...
                                    <?php 
                                        ...
                                        if (isset($_GET['command'])) {                                        
                                            ...
                                            elseif ($_GET['command'] == "templates" AND $rowPermission['set_template'] === 'yes') {
                                                require ADMIN_DIR . '/setings/templates-form.php';
                                            }
                                            elseif ($_GET['command'] == "menus") {
                                                require ADMIN_DIR . "/setings/menus-form.php";
                                            }
                                            elseif ($_GET['command'] == "phpinfo") {
                                                phpinfo();
                                            }
                                        }
                                        else {
