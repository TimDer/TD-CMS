...
if (isset($_SESSION['user'])) {
    ...
    $sqlpost        = "UPDATE posts SET category='$category', post_name='$post_name', post_1='$POST_lable_1', post_2='$POST_lable_2', post_3='$POST_lable_3', url='$url', date_edited='$edited' WHERE id='$postid'";
