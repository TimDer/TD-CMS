...
if (isset($_SESSION['user'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $mediaSHA1              = sha1(time() . '?' . date('Y') . '$' . mt_rand(100000000,999999999));
        $mediaName              = $imageExt[0];
        $mediaSql               = "INSERT INTO media (the_file_name, media_name, sha1_id) VALUES ('$imageName', '$mediaName', '$mediaSHA1')";
