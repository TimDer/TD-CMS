...
if (isset($_GET['del'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (file_exists(BASE_DIR . "/db.php")) {
            ...
            // put the settings in the settings table
            $sidename = mysqli_real_escape_string($conn, $_POST['sidename']);
            $sideslug = mysqli_real_escape_string($conn, $_POST['sideslug']);
            ...
            $TablesSQL = "CREATE TABLE `page` (`id` int(255) NOT NULL AUTO_INCREMENT,
                ...
                CREATE TABLE `posts` (`id` int(255) NOT NULL AUTO_INCREMENT,
                ...
                CREATE TABLE settings (id int(255) NOT NULL AUTO_INCREMENT,
                ...
                CREATE TABLE `downloads` (`id` int(255) NOT NULL AUTO_INCREMENT,
                ...
                CREATE TABLE `media` (`id` int(255) NOT NULL AUTO_INCREMENT,
                                        `the_file_name` text NOT NULL,
                ...
                CREATE TABLE `templates` (`id` int(255) NOT NULL AUTO_INCREMENT,
            ...
            ";
            $TablesSQLQuery = mysqli_multi_query($conn, $TablesSQL);

            if ($TablesSQLQuery) {
                $done = TRUE;    
            }
            else {
                echo 'sqlCreate Error: ' . $conn->error;
            }
        }
    }
}
