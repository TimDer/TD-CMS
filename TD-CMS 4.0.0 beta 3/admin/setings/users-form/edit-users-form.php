    ...
    if ($row = mysqli_fetch_assoc($queryUserEdit)) {
        ?>
            ...
            <form action="<?php echo ADMIN_URL; ?>/setings/users-submit.php?edituser=update" method="POST">
                ...
                <br class="br-6">
                <div class="col-sm-12">
                    <p class="col-sm-2">modify templates:</p>
                    <p class="col-sm-10">
                        <input type="radio" name="set_template" value="yes" <?php if ($row['set_template'] === 'yes') { echo 'checked'; } ?>> yes
                        <input type="radio" name="set_template" value="no" <?php if ($row['set_template'] === 'no') { echo 'checked'; } ?>> no
                    </p>
                </div>
                <br class="br-6">
                <div class="col-sm-12">
                    <p class="col-sm-2">modify menus:</p>
                    <p class="col-sm-10">
                        <input type="radio" name="menus" value="yes" <?php if ($row['menus'] === 'yes') { echo 'checked'; } ?>> yes
                        <input type="radio" name="menus" value="no" <?php if ($row['menus'] === 'no') { echo 'checked'; } ?>> no
                    </p>
                </div>
                <br class="br-6">
